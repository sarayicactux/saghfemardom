...
module.exports = {
    ...
    newList:function (req,res) {
        Models.CarAdv.findAll({
            ...
            .then(function (advs) {
                res.render('panel/manageInsCarAds/newsList',{advs:advs,jDate:jDate,needFul});
            })
    },
    accList:function (req,res) {
        Models.CarAdv.findAll({
            ...
            .then(function (advs) {
                res.render('panel/manageInsCarAds/checkedList',{lsTy:'تایید شده',advs:advs,jDate:jDate,needFul});
            })
    },
    nAccList:function (req,res) {
        Models.CarAdv.findAll({
            ...
            .then(function (advs) {
                res.render('panel/manageInsCarAds/checkedList',{lsTy:'رد شده',advs:advs,jDate:jDate,needFul});
            })
    },
    det:function (req,res) {
        ...
        Models.CarAdv.findOne({
            ...
            .then(function (adv) {
                if(adv.id != undefined){
                    res.render('panel/manageInsCarAds/det',{adv:adv,jDate:jDate,needFul});
                }
                else {
                    res.status(404);
